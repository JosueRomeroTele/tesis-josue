...
CREATE TABLE `artesanos` (
  ...
  PRIMARY KEY (`codigo`),
  KEY `fk_Artesanos_Comunidades1_idx` (`comunidad`),
  CONSTRAINT `FK5v60sol6tfn6xvk5yst1sdw4p` FOREIGN KEY (`comunidad`) REFERENCES `comunidades` (`codigo`),
  CONSTRAINT `fk_Artesanos_Comunidades1` FOREIGN KEY (`comunidad`) REFERENCES `comunidades` (`codigo`)
